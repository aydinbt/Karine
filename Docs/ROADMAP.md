...
- [~] **Sinematikte tek denetim GEÇ** — hızlandırma, duraklatma ve ilerleme çubuğu kaldırıldı; bunlar CCTV'ye ait. GEÇ kendi zemini, krem çerçevesi, eylem kenarı ve simgesiyle `KarineUI.SkipButton` oldu. **Ekranda görülmedi** → `[~]`.
